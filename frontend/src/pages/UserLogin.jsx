...
const UserLogin = () => {
  ...
  return (
    <div className="w-full h-screen relative">
      ...
      <div className="w-full h-screen flex items-center justify-center bg-[url('https://images.unsplash.com/photo-1632276536839-84cad7fd03b0?q=80&w=1964&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-cover bg-center px-4 sm:px-6">
        {/* Overlay */}
        ...
        <div className="relative z-10 w-full max-w-[400px] p-6 sm:p-8 bg-white/10 backdrop-blur-md">
          {/* Title */}
          <h1 className="text-3xl sm:text-4xl text-white font-[f2] font-semibold text-center mb-6">
            User Login
          </h1>
          ...
          <form onSubmit={submitHandler} className="flex flex-col gap-6">
            <div className="flex items-center border-b border-white/50 py-2">
              <i className="ri-mail-line text-white text-lg sm:text-xl mr-3"></i>
              <input
